...
.method private static getAnimId(Landroid/content/Context;Ljava/lang/String;)I
    .locals 3
...
.method public static getNextTask(Landroid/content/Context;ZI)Lcom/android/systemui/shared/recents/model/Task;
    ...
    invoke-static/range {p0 .. p0}, Lcom/miui/home/recents/RecentsModel;->getInstance(Landroid/content/Context;)Lcom/miui/home/recents/RecentsModel;

    move-result-object v9

    invoke-virtual {v9}, Lcom/miui/home/recents/RecentsModel;->getTaskLoader()Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;

    move-result-object v15

    move-object/from16 v0, p0

    invoke-virtual {v15, v0}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->createLoadPlan(Landroid/content/Context;)Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;
    ...
    invoke-virtual {v15, v5, v0}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->preloadTasks(Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;I)V

    invoke-virtual {v5}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->getTaskStack()Lcom/android/systemui/shared/recents/model/TaskStack;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/systemui/shared/recents/model/TaskStack;->getTaskCount()I

    move-result v17

    if-eqz v17, :cond_0

    invoke-virtual {v9}, Lcom/miui/home/recents/RecentsModel;->getRunningTask()Landroid/app/ActivityManager$RunningTaskInfo;
    ...
    :cond_2
    invoke-virtual/range {v16 .. v16}, Lcom/android/systemui/shared/recents/model/TaskStack;->getStackTasks()Ljava/util/ArrayList;
    ...
    const-string v17, "com.miui.home"
    ...
    iget-object v0, v14, Lcom/android/systemui/shared/recents/model/Task;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v14, Lcom/android/systemui/shared/recents/model/Task;->taskDescription:Landroid/app/ActivityManager$TaskDescription;
    ...
    invoke-virtual {v15, v0, v1, v2, v3}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateActivityIcon(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/app/ActivityManager$TaskDescription;Landroid/content/res/Resources;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v17

    move-object/from16 v0, v17

    iput-object v0, v14, Lcom/android/systemui/shared/recents/model/Task;->icon:Landroid/graphics/drawable/Drawable;
    ...
    const-string v17, "recents_quick_switch_left_enter"

    move-object/from16 v0, p0

    move-object/from16 v1, v17

    invoke-static {v0, v1}, Lcom/miui/home/recents/GestureStubView;->getAnimId(Landroid/content/Context;Ljava/lang/String;)I

    move-result v17

    const-string v18, "recents_quick_switch_left_exit"
    ...
    const-string v18, "setLaunchWindowingMode"
    ...
    invoke-interface {v7, v0, v1}, Landroid/app/IActivityManager;->startActivityFromRecents(ILandroid/os/Bundle;)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    check-cast v17, Lcom/android/systemui/shared/recents/model/Task;
    ...
    const-string v17, "recents_quick_switch_right_enter"
    ...
    const-string v18, "recents_quick_switch_right_exit"
