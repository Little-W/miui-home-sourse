.class public Lcom/android/ModsCenter/KaschiUtils;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/miui/home/launcher/Launcher;->getContext()Landroid/content/Context;

    move-result-object v0

    sput-object v0, Lcom/android/ModsCenter/KaschiUtils;->mContext:Landroid/content/Context;

    sget-object v0, Lcom/android/ModsCenter/KaschiUtils;->mContext:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    sput-object v0, Lcom/android/ModsCenter/KaschiUtils;->mContentResolver:Landroid/content/ContentResolver;
    ...
    sput-object v0, Lcom/android/ModsCenter/KaschiUtils;->mResources:Landroid/content/res/Resources;

    invoke-static {}, Landroid/animation/ArgbEvaluator;->getInstance()Landroid/animation/ArgbEvaluator;

    move-result-object v0

    sput-object v0, Lcom/android/ModsCenter/KaschiUtils;->mArgb:Landroid/animation/ArgbEvaluator;

    const-string v0, " / "

    sput-object v0, Lcom/android/ModsCenter/KaschiUtils;->mSlash:Ljava/lang/String;
    ...
    sput v0, Lcom/android/ModsCenter/KaschiUtils;->backgroundcolor:I
    ...
    sput v0, Lcom/android/ModsCenter/KaschiUtils;->whitecolor:I
...
.method public static getSystemBool(Ljava/lang/String;I)Z
    ...
    sget-object v0, Lcom/android/ModsCenter/KaschiUtils;->mContentResolver:Landroid/content/ContentResolver;
...
.method public static getSystemBools(Ljava/lang/String;I)Z
    ...
    invoke-static {p0, p1}, Lcom/android/ModsCenter/KaschiUtils;->getSystemInt(Ljava/lang/String;I)I
...
.method public static getTintedColor(FI)I
    ...
    sget-object v0, Lcom/android/ModsCenter/KaschiUtils;->mArgb:Landroid/animation/ArgbEvaluator;
