...
.method public constructor <init>(Lio/branch/search/w;Lio/branch/search/w3;Lio/branch/search/y;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    iget-wide v2, v1, Lio/branch/search/w3;->b:J

    iget-wide v4, p2, Lio/branch/search/w3;->b:J
    ...
    :cond_1
    :goto_0
    invoke-interface {p3}, Lio/branch/search/y;->a()Lio/branch/search/w3;

    move-result-object v1

    if-eqz v1, :cond_2

    iget v2, v1, Lio/branch/search/w3;->a:I

    iget v3, p2, Lio/branch/search/w3;->a:I
    ...
    :cond_2
    invoke-interface {p3, p2}, Lio/branch/search/y;->a(Lio/branch/search/w3;)V
    ...
    invoke-interface {p3, p2}, Lio/branch/search/y;->b(Lio/branch/search/w3;)V
