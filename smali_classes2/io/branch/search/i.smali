...
.method public a(Landroid/content/Context;Lio/branch/search/q;)Lio/branch/search/i$g;
    ...
    invoke-virtual {p0}, Lio/branch/search/i;->a()Lio/branch/search/IBranchIntentHandler;

    move-result-object v0

    invoke-virtual {p0, p1, p2, v0}, Lio/branch/search/i;->c(Landroid/content/Context;Lio/branch/search/q;Lio/branch/search/IBranchIntentHandler;)Lio/branch/search/i$g;
...
.method public abstract a(Landroid/content/Context;Lio/branch/search/q;Lio/branch/search/IBranchIntentHandler;)Lio/branch/search/i$g;
.end method
...
.method public abstract b(Landroid/content/Context;Lio/branch/search/q;Lio/branch/search/IBranchIntentHandler;)Z
.end method

.method public c(Landroid/content/Context;Lio/branch/search/q;Lio/branch/search/IBranchIntentHandler;)Lio/branch/search/i$g;
    .locals 1

    invoke-virtual {p0, p1, p2, p3}, Lio/branch/search/i;->b(Landroid/content/Context;Lio/branch/search/q;Lio/branch/search/IBranchIntentHandler;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lio/branch/search/i;->a(Landroid/content/Context;Lio/branch/search/q;Lio/branch/search/IBranchIntentHandler;)Lio/branch/search/i$g;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p0, p0, Lio/branch/search/i;->b:Ljava/lang/String;
