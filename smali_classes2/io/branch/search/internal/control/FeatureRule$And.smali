.class public final Lio/branch/search/internal/control/FeatureRule$And;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/branch/search/internal/control/FeatureRule$And$Companion;,
        Lio/branch/search/internal/control/FeatureRule$And$$serializer;
    }
.end annotation
...
# static fields
.field public static final Companion:Lio/branch/search/internal/control/FeatureRule$And$Companion;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lio/branch/search/internal/control/FeatureRule$And$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/branch/search/internal/control/FeatureRule$And$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lio/branch/search/internal/control/FeatureRule$And;->Companion:Lio/branch/search/internal/control/FeatureRule$And$Companion;
...
.method public synthetic constructor <init>(ILjava/util/List;Lkotlinx/serialization/internal/SerializationConstructorMarker;)V
    ...
    iput-object p2, p0, Lio/branch/search/internal/control/FeatureRule$And;->a:Ljava/util/List;
...
.method public static final a(Lio/branch/search/internal/control/FeatureRule$And;Lkotlinx/serialization/encoding/CompositeEncoder;Lkotlinx/serialization/descriptors/SerialDescriptor;)V
    .locals 11
    ...
    iget-object p0, p0, Lio/branch/search/internal/control/FeatureRule$And;->a:Ljava/util/List;
...
.method public a(Lio/branch/search/e0;)Z
    ...
    iget-object v0, p0, Lio/branch/search/internal/control/FeatureRule$And;->a:Ljava/util/List;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Lio/branch/search/internal/control/FeatureRule$And;

    if-eqz v0, :cond_0

    check-cast p1, Lio/branch/search/internal/control/FeatureRule$And;

    iget-object v0, p0, Lio/branch/search/internal/control/FeatureRule$And;->a:Ljava/util/List;

    iget-object p1, p1, Lio/branch/search/internal/control/FeatureRule$And;->a:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/branch/search/internal/control/FeatureRule$And;->a:Ljava/util/List;
