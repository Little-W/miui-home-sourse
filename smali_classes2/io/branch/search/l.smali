...
# static fields
.field public static l:Lio/branch/search/l;

.field public static m:Lio/branch/search/w;
...
.field public b:Lio/branch/search/c1;

.field public c:Lio/branch/search/b1;

.field public d:Lio/branch/search/z0;

.field public e:Lio/branch/search/internal/interfaces/LocalInterface;

.field public f:Lio/branch/search/o3;

.field public g:Lio/branch/search/n1;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lio/branch/search/l;->m:Lio/branch/search/w;
    ...
    sput-object v0, Lio/branch/search/l;->n:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;Lio/branch/search/BranchConfiguration;Lio/branch/search/e;)V
    ...
    iget-object v0, p2, Lio/branch/search/BranchConfiguration;->B:Lio/branch/search/w3;
    ...
    iput-object p2, p0, Lio/branch/search/l;->j:Lio/branch/search/BranchConfiguration;

    iput-object p3, p0, Lio/branch/search/l;->k:Lio/branch/search/e;
    ...
    iput-object p2, p0, Lio/branch/search/l;->h:Lio/branch/search/BranchAnalytics;

    new-instance p2, Lio/branch/search/o3;

    invoke-direct {p2, p1}, Lio/branch/search/o3;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lio/branch/search/l;->f:Lio/branch/search/o3;

    new-instance p1, Lio/branch/search/c1;

    invoke-direct {p1, p0}, Lio/branch/search/c1;-><init>(Lio/branch/search/l;)V

    iput-object p1, p0, Lio/branch/search/l;->b:Lio/branch/search/c1;

    new-instance p1, Lio/branch/search/b1;

    invoke-direct {p1, p0}, Lio/branch/search/b1;-><init>(Lio/branch/search/l;)V

    iput-object p1, p0, Lio/branch/search/l;->c:Lio/branch/search/b1;
    ...
    iput-object p1, p0, Lio/branch/search/l;->e:Lio/branch/search/internal/interfaces/LocalInterface;

    new-instance p1, Lio/branch/search/a1;

    invoke-direct {p1, p0}, Lio/branch/search/a1;-><init>(Lio/branch/search/l;)V

    iput-object p1, p0, Lio/branch/search/l;->d:Lio/branch/search/z0;

    new-instance p1, Lio/branch/search/x;

    sget-object p2, Lio/branch/search/l;->m:Lio/branch/search/w;

    new-instance p3, Lio/branch/search/y$a;

    iget-object v1, p0, Lio/branch/search/l;->j:Lio/branch/search/BranchConfiguration;

    iget-object v2, p0, Lio/branch/search/l;->e:Lio/branch/search/internal/interfaces/LocalInterface;

    iget-object p0, p0, Lio/branch/search/l;->h:Lio/branch/search/BranchAnalytics;

    invoke-direct {p3, v1, v2, p0}, Lio/branch/search/y$a;-><init>(Lio/branch/search/BranchConfiguration;Lio/branch/search/internal/interfaces/LocalInterface;Lio/branch/search/BranchAnalytics;)V

    invoke-direct {p1, p2, v0, p3}, Lio/branch/search/x;-><init>(Lio/branch/search/w;Lio/branch/search/w3;Lio/branch/search/y;)V
...
.method public static a(Landroid/content/Context;Lio/branch/search/BranchConfiguration;)Lio/branch/search/l;
    ...
    sget-object v0, Lio/branch/search/l;->l:Lio/branch/search/l;
    ...
    :cond_0
    invoke-static {}, Lio/branch/search/t0;->a()Lio/branch/search/t0;
    ...
    invoke-direct {v1, p0, p1, v2}, Lio/branch/search/l;-><init>(Landroid/content/Context;Lio/branch/search/BranchConfiguration;Lio/branch/search/e;)V

    sput-object v1, Lio/branch/search/l;->l:Lio/branch/search/l;

    iget-object p1, v1, Lio/branch/search/l;->k:Lio/branch/search/e;

    invoke-virtual {p1, p0}, Lio/branch/search/e;->a(Landroid/content/Context;)V

    sget-object p1, Lio/branch/search/l;->l:Lio/branch/search/l;
    ...
    sget-object p0, Lio/branch/search/l;->l:Lio/branch/search/l;

    invoke-virtual {p0}, Lio/branch/search/l;->h()V

    sget-object p0, Lio/branch/search/l;->n:Ljava/util/List;
    ...
    sget-object v1, Lio/branch/search/l;->l:Lio/branch/search/l;

    invoke-virtual {v1, p1}, Lio/branch/search/l;->trackAnalyticsEvent(Lio/branch/search/AnalyticsEvent;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lio/branch/search/f0;->a(Lio/branch/search/l;)V

    sget-object p0, Lio/branch/search/l;->l:Lio/branch/search/l;

    iget-object p0, p0, Lio/branch/search/l;->h:Lio/branch/search/BranchAnalytics;

    invoke-virtual {v0, p0}, Lio/branch/search/t0;->a(Lio/branch/search/BranchAnalytics;)V
...
.method public static optInToTracking()V
    ...
    sget-object v0, Lio/branch/search/l;->m:Lio/branch/search/w;
...
.method public static trackEvent(Lio/branch/search/AnalyticsEvent;)Z
    ...
    :cond_0
    sget-object v0, Lio/branch/search/l;->n:Ljava/util/List;
...
.method public a()Landroid/content/Context;
    ...
    iget-object p0, p0, Lio/branch/search/l;->a:Landroid/content/Context;
...
.method public a(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lio/branch/search/l;->f()Lio/branch/search/c1;

    move-result-object p0

    invoke-virtual {p0, p1}, Lio/branch/search/c1;->a(Ljava/lang/String;)V
...
.method public autoSuggest(Lio/branch/search/BranchAutoSuggestRequest;Lio/branch/search/IBranchAutoSuggestEvents;)Z
    ...
    iget-object p0, p0, Lio/branch/search/l;->b:Lio/branch/search/c1;

    invoke-virtual {p0, p1, p2}, Lio/branch/search/c1;->a(Lio/branch/search/BranchAutoSuggestRequest;Lio/branch/search/IBranchAutoSuggestEvents;)Z
...
.method public b()Lio/branch/search/BranchConfiguration;
    ...
    iget-object p0, p0, Lio/branch/search/l;->j:Lio/branch/search/BranchConfiguration;
...
.method public c()Lio/branch/search/e;
    ...
    iget-object p0, p0, Lio/branch/search/l;->k:Lio/branch/search/e;
...
.method public compositeSearch(Lio/branch/search/BranchCompositeSearchRequest;Lio/branch/search/IBranchExclusiveCompositeSearchPlusAppStoreEvents;)V
    ...
    iget-object p0, p0, Lio/branch/search/l;->c:Lio/branch/search/b1;

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0, v0, p2}, Lio/branch/search/b1;->a(Lio/branch/search/BranchCompositeSearchRequest;Lio/branch/search/ui/KBranchSearchEvents;Lio/branch/search/IBranchExclusiveCompositeSearchEvents;Lio/branch/search/IBranchExclusiveCompositeSearchPlusAppStoreEvents;)V
...
.method public f()Lio/branch/search/c1;
    .locals 0
...
.method public localQueryHint(Lio/branch/search/BranchQueryHintRequest;Lio/branch/search/IBranchLocalQueryHintEvents;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/branch/search/internal/interfaces/LocalInterface;->a(Lio/branch/search/BranchQueryHintRequest;Lio/branch/search/IBranchLocalQueryHintEvents;)V
...
.method public query(Lio/branch/search/BranchSearchRequest;Lio/branch/search/IBranchSearchEvents;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lio/branch/search/c1;->a(Lio/branch/search/BranchSearchRequest;Lio/branch/search/IBranchSearchEvents;)Z
...
.method public zeroState(Lio/branch/search/BranchZeroStateRequest;Lio/branch/search/ui/KBranchZeroStateEvents;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/branch/search/b1;->a(Lio/branch/search/BranchZeroStateRequest;Lio/branch/search/ui/KBranchZeroStateEvents;)V
