...
.method public static constructor <clinit>()V
    ...
    new-instance v2, Lio/branch/search/n1;
    ...
    invoke-direct {v2, v4, v3}, Lio/branch/search/n1;-><init>(ILjava/util/List;)V
    ...
    invoke-direct {v2, v6, v5}, Lio/branch/search/n1;-><init>(ILjava/util/List;)V
    ...
    sput-object v1, Lio/branch/search/o1;->a:Ljava/util/Map;

    const/4 v1, 0x6

    new-array v2, v1, [Lkotlin/Pair;

    sget-object v7, Lio/branch/search/d3;->g:Lio/branch/search/d3;

    new-instance v8, Lio/branch/search/n1;
    ...
    invoke-direct {v8, v0, v9}, Lio/branch/search/n1;-><init>(ILjava/util/List;)V
    ...
    sget-object v3, Lio/branch/search/d3;->c:Lio/branch/search/d3;

    new-instance v7, Lio/branch/search/n1;
    ...
    invoke-direct {v7, v9, v8}, Lio/branch/search/n1;-><init>(ILjava/util/List;)V
    ...
    sget-object v3, Lio/branch/search/d3;->j:Lio/branch/search/d3;

    new-instance v5, Lio/branch/search/n1;
    ...
    invoke-direct {v5, v1, v7}, Lio/branch/search/n1;-><init>(ILjava/util/List;)V
    ...
    sget-object v0, Lio/branch/search/d3;->f:Lio/branch/search/d3;
    ...
    invoke-direct {v3, v1, v5}, Lio/branch/search/n1;-><init>(ILjava/util/List;)V
    ...
    sget-object v0, Lio/branch/search/d3;->e:Lio/branch/search/d3;
    ...
    invoke-direct {v3, v1, v4}, Lio/branch/search/n1;-><init>(ILjava/util/List;)V
    ...
    sget-object v0, Lio/branch/search/d3;->l:Lio/branch/search/d3;
    ...
    sput-object v0, Lio/branch/search/o1;->b:Ljava/util/Map;
...
.method public static final a(Ljava/util/Collection;I)Ljava/util/Collection;
    ...
    sget-object v1, Lio/branch/search/o1;->a:Ljava/util/Map;
    ...
    check-cast v3, Lio/branch/search/n1;

    invoke-virtual {v3}, Lio/branch/search/n1;->b()I

    move-result v4

    if-le v4, p1, :cond_1

    invoke-virtual {v3}, Lio/branch/search/n1;->a()Ljava/util/List;
    ...
    sget-object v2, Lio/branch/search/o1;->b:Ljava/util/Map;
    ...
    check-cast v2, Lio/branch/search/n1;

    invoke-virtual {v2}, Lio/branch/search/n1;->b()I

    move-result v3

    if-le v3, p1, :cond_4

    invoke-virtual {v2}, Lio/branch/search/n1;->a()Ljava/util/List;
