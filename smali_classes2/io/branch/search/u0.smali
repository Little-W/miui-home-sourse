.class public final Lio/branch/search/u0;
...
.method public static final synthetic a(Lcom/bumptech/glide/request/FutureTarget;JJLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p5, Lio/branch/search/u0$c;

    if-eqz v0, :cond_0

    move-object v0, p5

    check-cast v0, Lio/branch/search/u0$c;

    iget v1, v0, Lio/branch/search/u0$c;->b:I
    ...
    iput v1, v0, Lio/branch/search/u0$c;->b:I

    goto :goto_0

    :cond_0
    new-instance v0, Lio/branch/search/u0$c;

    invoke-direct {v0, p5}, Lio/branch/search/u0$c;-><init>(Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p5, v0, Lio/branch/search/u0$c;->a:Ljava/lang/Object;

    invoke-static {}, Lkotlin/coroutines/intrinsics/IntrinsicsKt;->getCOROUTINE_SUSPENDED()Ljava/lang/Object;

    move-result-object v1

    iget v2, v0, Lio/branch/search/u0$c;->b:I
    ...
    new-instance p5, Lio/branch/search/u0$d;

    const/4 v2, 0x0

    invoke-direct {p5, p0, p3, p4, v2}, Lio/branch/search/u0$d;-><init>(Lcom/bumptech/glide/request/FutureTarget;JLkotlin/coroutines/Continuation;)V

    iput v3, v0, Lio/branch/search/u0$c;->b:I
...
.method public static final a(Lio/branch/search/k;Ljava/util/List;I)V
    ...
    sget-object p1, Lio/branch/search/u0$b;->a:Lio/branch/search/u0$b;
    ...
    new-instance p1, Lio/branch/search/u0$a;

    const/4 p2, 0x0

    invoke-direct {p1, v1, v0, p0, p2}, Lio/branch/search/u0$a;-><init>(Lkotlin/jvm/internal/Ref$ObjectRef;Lio/branch/search/v0;Lio/branch/search/k;Lkotlin/coroutines/Continuation;)V
