...
.method public static a(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v0, "io.branch.sdk.BranchTestKey"
    ...
    const-string v0, "Branch test key is used in release environment. Please switch to the live key."
    ...
    const-string v0, "Util.fetchBranchKey"
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Landroid/os/UserHandle;)Z
    ...
    invoke-static {p0, p1}, Lio/branch/search/Util;->isAppInstalled(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static b(Landroid/content/Context;Ljava/lang/String;Landroid/os/UserHandle;)Z
    .locals 6
    ...
    const-string v0, "Util.openApp"

    if-nez p0, :cond_0

    const-string p0, "launcherApps == null, should never happen"

    invoke-static {v0, p0}, Lio/branch/search/f0;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lio/branch/search/t;->a(Ljava/util/List;)Landroid/content/pm/LauncherActivityInfo;
    ...
    invoke-virtual {p0, v5, p2, v3, v3}, Landroid/content/pm/LauncherApps;->startMainActivity(Landroid/content/ComponentName;Landroid/os/UserHandle;Landroid/graphics/Rect;Landroid/os/Bundle;)V
    :try_end_1
    ...
    invoke-virtual {p0, p1, p2, v3, v3}, Landroid/content/pm/LauncherApps;->startAppDetailsActivity(Landroid/content/ComponentName;Landroid/os/UserHandle;Landroid/graphics/Rect;Landroid/os/Bundle;)V
...
.method public static d(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v0, "Util.getCountryCode"
