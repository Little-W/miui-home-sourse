...
.method public read(Lcom/mi/google/gson/stream/JsonReader;)Lcom/mi/google/gson/JsonElement;
    ...
    new-instance v1, Lcom/mi/google/gson/internal/LazilyParsedNumber;

    invoke-direct {v1, p1}, Lcom/mi/google/gson/internal/LazilyParsedNumber;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lcom/mi/google/gson/JsonPrimitive;-><init>(Ljava/lang/Number;)V
...
.method public write(Lcom/mi/google/gson/stream/JsonWriter;Lcom/mi/google/gson/JsonElement;)V
    ...
    .line 757
    invoke-virtual {p2}, Lcom/mi/google/gson/JsonPrimitive;->isNumber()Z
    ...
    .line 758
    invoke-virtual {p2}, Lcom/mi/google/gson/JsonPrimitive;->getAsNumber()Ljava/lang/Number;
    ...
    .line 759
    :cond_1
    invoke-virtual {p2}, Lcom/mi/google/gson/JsonPrimitive;->isBoolean()Z
    ...
    .line 760
    invoke-virtual {p2}, Lcom/mi/google/gson/JsonPrimitive;->getAsBoolean()Z

    move-result p2

    invoke-virtual {p1, p2}, Lcom/mi/google/gson/stream/JsonWriter;->value(Z)Lcom/mi/google/gson/stream/JsonWriter;

    goto/16 :goto_3

    .line 762
    :cond_2
    invoke-virtual {p2}, Lcom/mi/google/gson/JsonPrimitive;->getAsString()Ljava/lang/String;
