...
.method public write(Lcom/mi/google/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/mi/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->boundFields:Ljava/util/Map;
    ...
    invoke-virtual {v0, p2}, Lcom/mi/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->writeField(Ljava/lang/Object;)Z

    move-result v1

    if-eqz v1, :cond_1

    iget-object v1, v0, Lcom/mi/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->name:Ljava/lang/String;

    invoke-virtual {p1, v1}, Lcom/mi/google/gson/stream/JsonWriter;->name(Ljava/lang/String;)Lcom/mi/google/gson/stream/JsonWriter;

    invoke-virtual {v0, p1, p2}, Lcom/mi/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->write(Lcom/mi/google/gson/stream/JsonWriter;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
