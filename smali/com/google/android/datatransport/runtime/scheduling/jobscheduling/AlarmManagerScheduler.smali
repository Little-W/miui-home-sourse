...
.method public schedule(Lcom/google/android/datatransport/runtime/TransportContext;IZ)V
    ...
    invoke-virtual {p3, v0, v3, v4, p2}, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/SchedulerConfig;->getScheduleDelay(Lcom/google/android/datatransport/Priority;JI)J

    move-result-wide v5

    const-string p3, "AlarmManagerScheduler"

    const-string v0, "Scheduling upload for context %s in %dms(Backend next call timestamp %d). Attempt %d"
    ...
    .line 116
    invoke-static {p3, v0, v7}, Lcom/google/android/datatransport/runtime/logging/Logging;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
