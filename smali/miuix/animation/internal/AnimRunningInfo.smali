...
.method private setFromValue()V
    ...
    invoke-virtual {v2, v1, v0}, Lmiuix/animation/IAnimTarget;->setIntValue(Lmiuix/animation/property/IIntValueProperty;I)V
    ...
    invoke-virtual {v2, v1, v0}, Lmiuix/animation/IAnimTarget;->setValue(Lmiuix/animation/property/FloatProperty;F)V
...
.method private setStartTime(J)V
    ...
    .line 99
    invoke-virtual {p1}, Lmiuix/animation/styles/PropertyStyle;->resetRunningTime()V
...
.method begin(Lmiuix/animation/IAnimTarget;J)V
    ...
    invoke-static {p3, v2}, Lmiuix/animation/utils/LogUtils;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p3, v2, v3}, Lmiuix/animation/IAnimTarget;->setVelocity(Lmiuix/animation/property/FloatProperty;D)V
    ...
    const-string p3, "AnimRunningInfo, begin "
    ...
    invoke-virtual {p1}, Lmiuix/animation/styles/PropertyStyle;->start()V
...
.method getRunningTime()J
    ...
    :cond_0
    invoke-virtual {v0}, Lmiuix/animation/styles/PropertyStyle;->getRunningTime()J
...
.method isAnimEnd(J)Z
    ...
    invoke-virtual {p1}, Lmiuix/animation/styles/PropertyStyle;->isRunning()Z
...
.method isFinished()Z
    ...
    .line 49
    iget v0, p0, Lmiuix/animation/internal/AnimRunningInfo;->status:I
...
.method run(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lmiuix/animation/styles/PropertyStyle;->update(J)V
...
.method stop(Z)V
    ...
    invoke-virtual {v4}, Lmiuix/animation/property/FloatProperty;->getName()Ljava/lang/String;
    ...
    .line 214
    :goto_1
    iget-object p1, p0, Lmiuix/animation/internal/AnimRunningInfo;->pending:Lmiuix/animation/internal/AnimRunningInfo;

    if-eqz p1, :cond_4

    .line 215
    iput v2, p1, Lmiuix/animation/internal/AnimRunningInfo;->status:I
