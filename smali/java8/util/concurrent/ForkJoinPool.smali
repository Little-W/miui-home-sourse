...
.method private tryCompensate(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;)I
    ...
    .line 1628
    iget-wide v11, v8, Ljava8/util/concurrent/ForkJoinPool;->ctl:J
...
.method private tryTerminate(ZZ)Z
    ...
    .line 2179
    iget v6, v5, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->base:I

    iget v13, v5, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->id:I
    ...
    .line 2180
    iget v13, v5, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->top:I
    ...
    iget v5, v5, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->source:I
    ...
    .line 2207
    iget-object v14, v13, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->owner:Ljava8/util/concurrent/ForkJoinWorkerThread;

    .line 2208
    invoke-virtual {v13}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->cancelAll()V

    if-eqz v14, :cond_f

    .line 2211
    :try_start_0
    invoke-virtual {v14}, Ljava8/util/concurrent/ForkJoinWorkerThread;->interrupt()V
    :try_end_0
    ...
    :catch_0
    :cond_f
    iget v14, v13, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->base:I

    iget v13, v13, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->id:I
    ...
    iget-object v14, v7, Ljava8/util/concurrent/ForkJoinPool;->workQueues:[Ljava8/util/concurrent/ForkJoinPool$WorkQueue;
...
.method final helpQuiescePool(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;)V
    ...
    .line 1872
    iput v7, v1, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->source:I
    ...
    invoke-static {v0, v4, v5, v8, v9}, Ljava8/util/concurrent/ForkJoinPool;->getAndAddLong(Ljava/lang/Object;JJ)J
...
.method final registerWorker(Ljava8/util/concurrent/ForkJoinWorkerThread;)Ljava8/util/concurrent/ForkJoinPool$WorkQueue;
    ...
    .line 1429
    invoke-virtual {p1, v0}, Ljava8/util/concurrent/ForkJoinWorkerThread;->setDaemon(Z)V
    ...
    .line 1431
    invoke-virtual {p1, v1}, Ljava8/util/concurrent/ForkJoinWorkerThread;->setUncaughtExceptionHandler(Ljava/lang/Thread$UncaughtExceptionHandler;)V
...
.method final runWorker(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;)V
    ...
    .line 1667
    iget v1, v7, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->id:I
    ...
    .line 1676
    :cond_1
    iput v1, v9, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->source:I

    .line 1677
    invoke-virtual {v11}, Ljava8/util/concurrent/ForkJoinTask;->doExec()I

    .line 1678
    iget v5, v9, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->id:I
    ...
    .line 1682
    :goto_2
    iget-object v5, v9, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->owner:Ljava8/util/concurrent/ForkJoinWorkerThread;
    ...
    .line 1686
    invoke-virtual {v5}, Ljava8/util/concurrent/ForkJoinWorkerThread;->afterTopLevelExec()V
    ...
    .line 1715
    :goto_6
    iget v1, v9, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->phase:I
    ...
    .line 1719
    :cond_b
    iget v1, v8, Ljava8/util/concurrent/ForkJoinPool;->mode:I
    ...
    .line 1724
    invoke-direct {v8, v6, v6}, Ljava8/util/concurrent/ForkJoinPool;->tryTerminate(ZZ)Z
