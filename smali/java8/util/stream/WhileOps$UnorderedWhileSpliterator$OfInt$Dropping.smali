...
.method public tryAdvance(Ljava8/util/function/IntConsumer;)Z
    ...
    .line 932
    iget-boolean v0, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->takeOrDrop:Z
    ...
    .line 933
    iput-boolean v0, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->takeOrDrop:Z

    const/4 v1, 0x1

    .line 936
    :goto_0
    iget-object v2, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->s:Ljava8/util/Spliterator;
    ...
    .line 937
    invoke-virtual {p0}, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->checkCancelOnCount()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v3, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->p:Ljava8/util/function/IntPredicate;

    iget v4, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->t:I
    ...
    .line 947
    iget-object v0, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->cancel:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    .line 948
    :cond_1
    iget v0, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->t:I
    ...
    .line 953
    :cond_3
    iget-object v0, p0, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfInt$Dropping;->s:Ljava8/util/Spliterator;
