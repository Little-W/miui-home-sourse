...
.method public compute()V
    ...
    .line 311
    invoke-virtual {v5, v1}, Ljava8/util/stream/AbstractTask;->makeChild(Ljava8/util/Spliterator;)Ljava8/util/stream/AbstractTask;

    move-result-object v2

    iput-object v2, v5, Ljava8/util/stream/AbstractTask;->leftChild:Ljava8/util/stream/AbstractTask;

    .line 312
    invoke-virtual {v5, v0}, Ljava8/util/stream/AbstractTask;->makeChild(Ljava8/util/Spliterator;)Ljava8/util/stream/AbstractTask;

    move-result-object v7

    iput-object v7, v5, Ljava8/util/stream/AbstractTask;->rightChild:Ljava8/util/stream/AbstractTask;

    const/4 v8, 0x1

    .line 313
    invoke-virtual {v5, v8}, Ljava8/util/stream/AbstractTask;->setPendingCount(I)V
    ...
    .line 325
    invoke-virtual {v2}, Ljava8/util/stream/AbstractTask;->fork()Ljava8/util/concurrent/ForkJoinTask;
    ...
    .line 328
    :cond_1
    invoke-virtual {v5}, Ljava8/util/stream/AbstractTask;->doLeaf()Ljava/lang/Object;

    move-result-object v0

    invoke-virtual {v5, v0}, Ljava8/util/stream/AbstractTask;->setLocalResult(Ljava/lang/Object;)V

    .line 329
    invoke-virtual {v5}, Ljava8/util/stream/AbstractTask;->tryComplete()V
...
.method protected getParent()Ljava8/util/stream/AbstractTask;
    ...
    .line 286
    invoke-virtual {p0}, Ljava8/util/stream/AbstractTask;->getCompleter()Ljava8/util/concurrent/CountedCompleter;
