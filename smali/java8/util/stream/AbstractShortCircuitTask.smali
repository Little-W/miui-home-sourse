...
.method protected cancelLaterNodes()V
    ...
    .line 224
    invoke-virtual {p0}, Ljava8/util/stream/AbstractShortCircuitTask;->getParent()Ljava8/util/stream/AbstractTask;
    ...
    .line 228
    iget-object v2, v0, Ljava8/util/stream/AbstractShortCircuitTask;->leftChild:Ljava8/util/stream/AbstractTask;

    if-ne v2, v1, :cond_0

    .line 229
    iget-object v1, v0, Ljava8/util/stream/AbstractShortCircuitTask;->rightChild:Ljava8/util/stream/AbstractTask;
    ...
    .line 226
    :cond_0
    invoke-virtual {v0}, Ljava8/util/stream/AbstractShortCircuitTask;->getParent()Ljava8/util/stream/AbstractTask;
...
.method public compute()V
    ...
    .line 103
    iget-object v0, p0, Ljava8/util/stream/AbstractShortCircuitTask;->spliterator:Ljava8/util/Spliterator;
    ...
    .line 105
    invoke-virtual {p0, v1, v2}, Ljava8/util/stream/AbstractShortCircuitTask;->getTargetSize(J)J
    ...
    .line 111
    invoke-virtual {v0}, Ljava8/util/stream/AbstractShortCircuitTask;->taskCanceled()Z
    ...
    .line 112
    invoke-virtual {v0}, Ljava8/util/stream/AbstractShortCircuitTask;->getEmptyResult()Ljava/lang/Object;
    ...
    .line 120
    :cond_1
    invoke-virtual {v0, v1}, Ljava8/util/stream/AbstractShortCircuitTask;->makeChild(Ljava8/util/Spliterator;)Ljava8/util/stream/AbstractTask;

    move-result-object v2

    check-cast v2, Ljava8/util/stream/AbstractShortCircuitTask;

    iput-object v2, v0, Ljava8/util/stream/AbstractShortCircuitTask;->leftChild:Ljava8/util/stream/AbstractTask;

    .line 121
    invoke-virtual {v0, v6}, Ljava8/util/stream/AbstractShortCircuitTask;->makeChild(Ljava8/util/Spliterator;)Ljava8/util/stream/AbstractTask;

    move-result-object v8

    check-cast v8, Ljava8/util/stream/AbstractShortCircuitTask;

    iput-object v8, v0, Ljava8/util/stream/AbstractShortCircuitTask;->rightChild:Ljava8/util/stream/AbstractTask;

    const/4 v9, 0x1

    .line 122
    invoke-virtual {v0, v9}, Ljava8/util/stream/AbstractShortCircuitTask;->setPendingCount(I)V
    ...
    .line 134
    invoke-virtual {v2}, Ljava8/util/stream/AbstractShortCircuitTask;->fork()Ljava8/util/concurrent/ForkJoinTask;
    ...
    :cond_3
    :goto_2
    invoke-virtual {v0}, Ljava8/util/stream/AbstractShortCircuitTask;->doLeaf()Ljava/lang/Object;
    ...
    :cond_4
    :goto_3
    invoke-virtual {v0, v8}, Ljava8/util/stream/AbstractShortCircuitTask;->setLocalResult(Ljava/lang/Object;)V

    .line 138
    invoke-virtual {v0}, Ljava8/util/stream/AbstractShortCircuitTask;->tryComplete()V
...
.method public getLocalResult()Ljava/lang/Object;
    ...
    .line 186
    invoke-virtual {p0}, Ljava8/util/stream/AbstractShortCircuitTask;->isRoot()Z
...
.method protected taskCanceled()Z
    ...
    .line 210
    invoke-virtual {v1}, Ljava8/util/stream/AbstractShortCircuitTask;->getParent()Ljava8/util/stream/AbstractTask;
